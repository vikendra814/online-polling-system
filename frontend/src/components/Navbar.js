...
//   return (
//     <>
//       <nav className={`navbar navbar-expand-lg  px-4 bg-dark text-light`}>
//         Voting.com
//         <button
...
//               <ul className="navbar-nav">
//                 <li className="nav-item active">
//               <Link className={`nav-link text-bold text-light`} to="/show-result">
//                See Voting Result
//               </Link>
//             </li>
//                 <li className="nav-item active">
      ...
      <nav className={`navbar navbar-expand-lg  px-4 bg-dark text-light`}>
        ...
        >
          <ul className="navbar-nav">
            <li className="nav-item active">
              <Link
                className={`nav-link text-bold text-light`}
                to="/userPoll"
              >
                See Voting Result
              </Link>
